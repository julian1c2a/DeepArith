...
lean_object* initialize_DeepArithmetic_DeepArithmetic_LogicAbstraction_TuringProofs(uint8_t builtin);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_DeepArithmetic_DeepArithmetic_LogicAbstraction_TuringProofs(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
