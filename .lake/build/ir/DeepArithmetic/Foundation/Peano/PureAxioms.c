...
// Module: DeepArithmetic.Foundation.Peano.PureAxioms
...
LEAN_EXPORT lean_object* initialize_DeepArithmetic_DeepArithmetic_Foundation_Peano_PureAxioms(uint8_t builtin) {
lean_object * res;
