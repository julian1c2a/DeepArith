...
// Module: DeepArithmetic.Foundation.Lists.PureAxioms
...
LEAN_EXPORT lean_object* initialize_DeepArithmetic_DeepArithmetic_Foundation_Lists_PureAxioms(uint8_t builtin) {
lean_object * res;
