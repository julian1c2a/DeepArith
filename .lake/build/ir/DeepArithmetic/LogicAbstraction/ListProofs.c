...
// Module: DeepArithmetic.LogicAbstraction.ListProofs
...
static lean_once_cell_t lp_DeepArithmetic_DeepArithmetic_LogicAbstraction_ListProofs_ListAxiomContext___closed__0_once = LEAN_ONCE_CELL_INITIALIZER;
static lean_object* lp_DeepArithmetic_DeepArithmetic_LogicAbstraction_ListProofs_ListAxiomContext___closed__0;
LEAN_EXPORT lean_object* lp_DeepArithmetic_DeepArithmetic_LogicAbstraction_ListProofs_ListAxiomContext;
static lean_object* _init_lp_DeepArithmetic_DeepArithmetic_LogicAbstraction_ListProofs_ListAxiomContext___closed__0(void){
_start:
{
...
static lean_object* _init_lp_DeepArithmetic_DeepArithmetic_LogicAbstraction_ListProofs_ListAxiomContext(void){
_start:
{
lean_object* v___x_4_; 
v___x_4_ = lean_obj_once(&lp_DeepArithmetic_DeepArithmetic_LogicAbstraction_ListProofs_ListAxiomContext___closed__0, &lp_DeepArithmetic_DeepArithmetic_LogicAbstraction_ListProofs_ListAxiomContext___closed__0_once, _init_lp_DeepArithmetic_DeepArithmetic_LogicAbstraction_ListProofs_ListAxiomContext___closed__0);
return v___x_4_;
}
}
...
LEAN_EXPORT lean_object* initialize_DeepArithmetic_DeepArithmetic_LogicAbstraction_ListProofs(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
lp_DeepArithmetic_DeepArithmetic_LogicAbstraction_ListProofs_ListAxiomContext = _init_lp_DeepArithmetic_DeepArithmetic_LogicAbstraction_ListProofs_ListAxiomContext();
lean_mark_persistent(lp_DeepArithmetic_DeepArithmetic_LogicAbstraction_ListProofs_ListAxiomContext);
